...
palavras = {
  facil: ['sutil', 'desde', 'inato', 'audaz', 'vigor', 'chegar', 'facil', 'legal', 'chute', 'bacana'],
  medio: ['refutar', 'alusão', 'cordial', 'ênfase', 'naruto'],
  dificil: ['modéstia', 'misógino', 'empírico', 'impetuoso', 'rechaçar', 'depravado']
};

function limpar() {
  jogo = {
    dificuldade: undefined,
    palavra: undefined, // 'PALAVRA'
    palavraSemAcentos: undefined,
    acertos: undefined, // '_ _ _ A _ _ _  '
    jogadas: [],
    chances: 6,
...
function mostrarMensagem(vitoria){
  ...
  ? '<p>Parabains!</p><p>Ganhaste</p>' 
  : '<p>Lixaste</p><p>Perdeste!</p>';
